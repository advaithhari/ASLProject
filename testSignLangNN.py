...
image1 = cv2.imread('numbersDataset/unknown/unknown_8.jpg') # read in all of the numbers
image2 = cv2.imread('numbersDataset/1/one_5.jpg')
image3 = cv2.imread('testnums/9.jpg')
...
image1 = resize(image1,img_width, img_height)#using our resize function and inputing a height and width
